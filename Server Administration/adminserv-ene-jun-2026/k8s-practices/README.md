...
| `manifests/helm/` | Práctica de Helm para gestionar paquetes. |
...
### Objetivo
Aprender a gestionar aplicaciones como paquetes usando **Helm**, el gestor de paquetes de Kubernetes.
...
2. **Instalar el Chart**:
   ```bash
   cd k8s-practices/manifests/helm
