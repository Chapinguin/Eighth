...
| 9 | **Estabilidad y Recursos** | Controlar el consumo de RAM/CPU y configurar autocurado. | `limits`, `healthcheck`, `restart: always`. | [9-Estabilidad-y-Recursos](./9-Estabilidad-y-Recursos/) |